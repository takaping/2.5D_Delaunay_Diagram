...
void GraphicsView::on_realize() {
    ...
    {
        // material properties of the front face
    ...
    {
        // material properties of the back face
        GLfloat spc[] = { 0.6f,  0.2f,  0.0f, 0.7f };
        GLfloat dif[] = { 0.3f,  0.1f,  0.0f, 0.7f };
        GLfloat amb[] = { 0.1f,  0.0f,  0.0f, 0.7f };
